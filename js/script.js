...
$(document).ready(function(){
 ...
 $("#navbar_scroll_tshirt").click(function(){
  $('html, body').animate({
    scrollTop: $($("#tshirt-section")).offset().top -46}, 600,'swing');
 });
 $("#navbar_scroll_customize").click(function(){
  $('html, body').animate({
    scrollTop: $($("#customized-section")).offset().top - 72}, 600,'swing');
 });
 $("#navbar_scroll_product").click(function(){
  $('html, body').animate({
    scrollTop: $($("#product-section")).offset().top -100}, 600,'swing');
 });
 $("#navbar_scroll_contact").click(function(){
  $('html, body').animate({
